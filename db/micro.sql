/*
 ...
 Source Host           : 192.168.0.242:3306
 Source Schema         : micro
...
CREATE TABLE `app`  (
  ...
  `del_flag` smallint NULL DEFAULT NULL COMMENT '删除状态(0-正常,1-已删除)',
  ...
  `category_id` bigint NULL DEFAULT NULL COMMENT '应用类别id',
...
CREATE TABLE `app_category`  (
  ...
  `order_no` int NULL DEFAULT NULL COMMENT '序号',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `app_form`  (
  ...
  `open` smallint NULL DEFAULT NULL COMMENT '是否开启访问',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `app_form` VALUES (661518566213, 0, 'admin', '2023-04-30 00:00:00', 'admin', '2023-04-30 00:00:00', '表单提交', 596408555333, '{\"widgetList\":[{\"type\":\"input\",\"name\":\"输入框\",\"icon\":\"text-field\",\"options\":{\"name\":\"inputheeot\",\"group\":\"\",\"type\":\"text\",\"defaultValue\":\"\",\"placeholder\":\"\",\"size\":\"\",\"span\":24,\"minLength\":null,\"maxLength\":null,\"readonly\":false,\"disabled\":false,\"clearable\":true,\"showPassword\":false,\"showWordLimit\":false},\"form-item\":{\"label\":\"输入框\",\"disabled\":false,\"hidden\":false,\"width\":null,\"required\":true,\"validation\":\"\",\"validationHint\":\"\"},\"events\":{\"onValidate\":\"\",\"onAppendButtonClick\":\"\",\"input\":\"\",\"change\":\"\",\"focus\":\"\",\"blur\":\"\"},\"id\":\"inputheeot\"},{\"type\":\"grid\",\"name\":\"栅格\",\"icon\":\"grid\",\"widgetList\":[{\"type\":\"submit\",\"name\":\"提交\",\"icon\":\"\",\"options\":{\"name\":\"submithfvur\",\"label\":\"提交\",\"size\":\"\",\"button-type\":\"\",\"icon\":\"\",\"span\":24,\"disabled\":false,\"hidden\":false,\"plain\":false,\"round\":false,\"circle\":false},\"events\":{\"click\":\"console.log(this.$model)\"},\"id\":\"submithfvur\"}],\"options\":{\"name\":\"gridhejxo\",\"gutter\":10,\"type\":\"flex\",\"justify\":\"center\",\"align\":\"\",\"span\":24},\"id\":\"gridhejxo\"}],\"formConfig\":{\"width\":\"780px\",\"size\":\"\",\"labelWidth\":80,\"labelPosition\":\"left\",\"disabled\":false,\"dataCode\":\"\",\"functionCode\":\"\",\"onCreated\":\"\",\"onMounted\":\"\",\"apis\":[]}}', NULL, NULL, NULL, 1);
...
CREATE TABLE `datasource`  (
  ...
  `name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '数据源名称',
  `type` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '0' COMMENT '数据源类型',
  `url` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '数据源地址',
  ...
  `del_flag` smallint NULL DEFAULT 0 COMMENT '删除标志（0代表存在 1代表删除）',
  `create_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `header` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '请求头',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '数据源' ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of datasource
-- ----------------------------
INSERT INTO `datasource` VALUES (661179312645, '本地rest数据源', 'rest', 'http://127.0.0.1:4000/micro', 10000, NULL, NULL, '测试', 0, 'admin', '2023-04-30 00:00:00', '', '2023-04-30 00:00:00', '[{\"key\":\"x\",\"value\":\"123\"},{\"key\":\"y\",\"value\":\"456\"}]');
INSERT INTO `datasource` VALUES (661337364485, '本地mysql数据源', 'mysql', 'jdbc:mysql://127.0.0.1:3306/database?characterEncoding=UTF-8&useUnicode=true&useSSL=false&tinyInt1isBit=false&allowPublicKeyRetrieval=true&serverTimezone=Asia/Shanghai', 10000, 'root', '443967e8cfda5646d4f3e044f7a18704', NULL, 1, 'admin', '2023-04-30 00:00:00', '', NULL, NULL);
...
-- Records of rest_api
-- ----------------------------
INSERT INTO `rest_api` VALUES (1, 'listEntity', '/test/table', 'GET', 5000, NULL, 'a:12234', '...searchForm', NULL, 0, 'admin', '2023-03-17 19:38:53', 'admin', '2023-05-03 00:00:00', 'tables=res', NULL, 601437254789, 661179312645);
INSERT INTO `rest_api` VALUES (605967211397, 'listChartDong', '/test/chartDong', 'GET', 5000, '查询东部地区经济', NULL, '...searchForm', '', 0, 'admin', '2023-04-20 00:00:00', 'admin', '2023-05-03 00:00:00', 'chartDong=res', NULL, 602891849349, 661179312645);
INSERT INTO `rest_api` VALUES (606804793029, 'listChartZhong', '/test/chartZhong', 'GET', 5000, '查询中部地区经济', NULL, '...searchForm', NULL, 0, 'admin', '2023-04-20 00:00:00', 'admin', '2023-05-03 00:00:00', 'chartZhong=res', NULL, 602891849349, 661179312645);
INSERT INTO `rest_api` VALUES (606808050629, 'listChartXi', '/test/chartXi', 'GET', 5000, '查询西部地区经济', NULL, '...searchForm', NULL, 0, 'admin', '2023-04-20 00:00:00', 'admin', '2023-05-03 00:00:00', 'chartXi=res', NULL, 602891849349, 661179312645);
INSERT INTO `rest_api` VALUES (606811191493, 'listChartBei', '/test/chartBei', 'GET', 5000, '查询东北地区经济', NULL, '...searchForm', NULL, 0, 'admin', '2023-04-20 00:00:00', 'admin', '2023-05-03 00:00:00', 'chartBei=res', NULL, 602891849349, 661179312645);
