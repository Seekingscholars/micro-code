  ...
  <div>
      ...
      <el-collapse v-model="formActiveCollapseNames" class="setting-collapse">
        ...
        <el-collapse-item name="2" title="事件属性">
          <el-form-item label="onCreated" label-width="120px">
            <el-button icon="el-icon-edit" plain round type="info" @click="editFormEventHandler('onCreated')">
              编写代码
            </el-button>
          </el-form-item>
          <el-form-item label="onMounted" label-width="120px">
            <el-button icon="el-icon-edit" plain round type="info" @click="editFormEventHandler('onMounted')">
              编写代码
            </el-button>
          </el-form-item>
        </el-collapse-item>
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="saveGlobalFunction">
          确定
        </el-button>
      </div>
    </el-dialog>
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="saveGlobalData">
          确定
        </el-button>
      </div>
    </el-dialog>
