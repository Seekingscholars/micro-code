<template>
  <el-dialog :show-close="false" :title="title" append-to-body v-bind="$attrs">
    <el-tabs v-model="activeTab" class="no-box-shadow no-padding" type="border-card">
      ...
      <el-tab-pane label="请求头信息" name="header">
        ...
        <code-editor v-model="modelForm.header" :mode="'javascript'" :readonly="false" />
        <el-alert :closable="false" title="}" type="info" />
      </el-tab-pane>
      <el-tab-pane label="请求参数" name="param">
        <el-alert :closable="false" title="{" type="info" />
        <code-editor v-model="modelForm.param" :mode="'javascript'" :readonly="false" />
        <el-alert :closable="false" title="}" type="info" />
      </el-tab-pane>
      <el-tab-pane label="请求体" name="body">
        <el-alert :closable="false" title="{" type="info" />
        <code-editor v-model="modelForm.body" :mode="'javascript'" :readonly="false" />
        <el-alert :closable="false" title="}" type="info" />
      </el-tab-pane>
      <el-tab-pane label="请求后成功处理函数" name="success">
        <el-alert :closable="false" title="function(res){" type="info" />
        <code-editor v-model="modelForm.successFunction" :mode="'javascript'" :readonly="false" />
        <el-alert :closable="false" title="}" type="info" />
      </el-tab-pane>
      <el-tab-pane label="请求后失败处理函数" name="fail">
        <el-alert :closable="false" title="function(error){" type="info" />
        <code-editor v-model="modelForm.failFunction" :mode="'javascript'" :readonly="false" />
        <el-alert :closable="false" title="}" type="info" />
      </el-tab-pane>
    </el-tabs>
