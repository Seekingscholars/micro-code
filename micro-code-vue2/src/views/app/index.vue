      ...
      <el-aside>
        <div>
          <div v-for="item in formList" :key="item.id"
               :class="{'app-form':true,'app-form-selected':selectFormId===item.id}" @click="onFormClick">
            <div>
              ...
              >
                <div class="app-form-setting-menu">
                  <div class="app-form-setting-menu-item" @click="handleFormEdit"><i class="el-icon-edit"/><span
                    class="app-form-setting-menu-item-title">编辑</span></div>
                  <div class="app-form-setting-menu-item" style="color: #ef5c5c"><i class="el-icon-delete"/><span
                    class="app-form-setting-menu-item-title">删除</span></div>
                </div>
